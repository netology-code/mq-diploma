...
При разработке проекта и для итоговой демонстрации вам нужно использовать сервис GitHub Pages. Перед работой с сервисом ознакомьтесь с инструкцией [по ссылке](https://github.com/netology-code/guides/blob/mq-gh/mq-gh-pages/README.md)
